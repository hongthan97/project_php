...
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <title>Hóa đơn <?= $_SESSION['chi_tiet_hoa_don']['ma_hd'] ?></title>
    ...
    <div class="row" style="margin-left: 180px; margin-right: 180px">
      ...
      <div class="col-lg-12 col-xlg-9 col-md-7" align="center">
        ...
        <br><div class="form-group">
          ...
          <center><label class="col-md-12"><h3 class="page-header">CHI TIẾT HÓA ĐƠN</h3></label></center>
        </div>
        <div class="col-md-12">
          <div style="float: left; margin-left: 10px; margin-right: 10px; margin-bottom: 40px; margin-top: 20px">
          ...
          <tbody align="center">
            ...
            foreach ($_SESSION['chi_tiet_san_pham'] as $value){
              ...
              <tr style="font-size: 18px">
                ...
                <td class="price">
                  <span><?= number_format($value['gia_ban']).' VNĐ' ?></span>
                </td>
                <td class="qty">
                ...
                <td>
                  <span><?= number_format($value['thanh_tien']).' VNĐ' ?></span>
                </td>
              </tr>
            <?php } ?>
            <tr>
              <td colspan="2" align="center"><h4><i class="mdi mdi-coins"></i> Tổng tiền</h4></td>
              <td colspan="2" align="center"><h4 style="color: green"><?= number_format($_SESSION['chi_tiet_hoa_don']['tong_tien']).' VNĐ' ?></h4></td>
            </tr>
          </tbody>
        </table>
      </div>
      <button class="btn btn-md btn-info btn-rounded" onclick="window.print()"><i class="mdi mdi-printer"></i> In hóa đơn</button>
      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp

      <a type="button" class="btn btn-md btn-danger btn-rounded" href="index.php?mod=sale&act=billdetail&ma_hd=<?= $_SESSION['chi_tiet_hoa_don']['ma_hd'] ?>"><i class="mdi mdi-printer"></i> Quay lại</a>
