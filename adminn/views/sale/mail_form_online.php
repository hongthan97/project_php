    ...
    <div class="row" style="width: 100%">
      ...
      <div class="col-lg-12 col-xlg-9 col-md-7" align="center">
        ...
        <br><div class="form-group">
          ...
          <center><label class="col-md-12"><h2 class="page-header">CHI TIẾT HÓA ĐƠN ONLINE</h2></label></center>
        </div>
        <div class="col-md-12">
          <div style="float: left; margin-left: 20px; margin-right: 20px; margin-bottom: 40px; margin-top: 20px">
            ...
            <div><?= $_SESSION['chi_tiet_hoa_don_online']['ten_kh'] ?></div>
          </div>
          <div style="float: left; margin-left: 20px; margin-right: 20px; margin-bottom: 40px; margin-top:20px">
            <label class="col-md-12" style="font-size: 20px">Mã hóa đơn:</label><br>
            <div><?= $_SESSION['chi_tiet_hoa_don_online']['ma_hd'] ?></div>
          </div>
          <div style="float: left; margin-left: 20px; margin-right: 20px; margin-bottom: 40px; margin-top:20px">
            <label class="col-md-12" style="font-size: 20px">Ngày bán:</label><br>
            <div><?= $_SESSION['chi_tiet_hoa_don_online']['ngay_ban'] ?></div>
          </div>
          <div style="float: left; margin-left: 20px; margin-right: 20px; margin-bottom: 40px; margin-top:20px">
            <label class="col-md-12" style="font-size: 20px">Mã khách hàng:</label><br>
            <div><?= $_SESSION['chi_tiet_hoa_don_online']['ma_kh'] ?></div>
          </div>
          <div style="float: left; margin-left: 20px; margin-right: 20px; margin-bottom: 40px; margin-top:20px">
       ...
       <br><div class="cart-table clearfix" align="center">
        <table class="table table-condensed" align="center">
          ...
          <tbody align="center">
            <?php 
            foreach ($_SESSION['chi_tiet_san_pham_online'] as $value){
            ...
            <tr>
              ...
              <td colspan="2" align="center"><h2 style="color: green"><?= number_format($_SESSION['chi_tiet_hoa_don_online']['tong_tien']) ?></h2></td>
            </tr>
          </tbody>
        </table>
      </div>
