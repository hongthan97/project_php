    ...
    <div class="card">
      <div class="card-block">
        <div class="col-md-12 col-5 align-self-center">
          <a href="index.php?mod=products&act=add" class="pull-right waves-effect waves-dark btn btn-primary btn-md btn-rounded"><i class="mdi mdi-cart-outline"></i> Thêm mới</a>
        </div>
        
        <h2 class="page-header"><i class="mdi mdi-bulletin-board"></i> Quản lí sản phẩm</h2><br>
